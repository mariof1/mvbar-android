...
Follow-up: strengthened the moving row highlight with a cyan outline and background and added Play all above the list. Debug build, unit tests, and lint pass. Visually verified the held-row highlight; live Play all started the seven favorites from the first track and was paused after verification.
