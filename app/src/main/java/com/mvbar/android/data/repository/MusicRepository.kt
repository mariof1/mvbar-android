...
class MusicRepository(private val db: MvbarDatabase? = null) {
    ...
    suspend fun getRecommendationFeedback() = api.getRecommendationFeedback()
    suspend fun clearAllRecommendationFeedback() = api.clearAllRecommendationFeedback()
    suspend fun clearHiddenRecommendationBuckets() = api.clearHiddenRecommendationBuckets()
