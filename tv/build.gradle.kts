...
android {
    namespace = "com.mvbar.android.tv"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.mvbar.android.tv"
        minSdk = 26
        targetSdk = 34
...
dependencies {
    ...
    // 1.0.1 is the current line compatible with this project's AGP 8.5 / compileSdk 34 baseline.
    ...
    // Keep the TV sign-in contract aligned with the phone app.
